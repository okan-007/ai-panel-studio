...
const SEED_DISCUSSIONS: SeedDiscussion[] = [
  ...
  // -------------------------------------------------------------------------
  // 6. Social Media & Youth Mental Health
  // -------------------------------------------------------------------------
  {
    title: "社交媒体对青少年心理健康的影响：监管、教育还是技术解决？",
    background:
      "研究表明，每天使用社交媒体超过3小时的青少年出现焦虑和抑郁症状的概率是普通青少年的两倍。各国政府开始推动立法限制未成年人使用社交媒体，Meta和TikTok等平台也推出了家长控制功能。但究竟应该由谁承担主要责任？",
    template: "debate",
    maxRounds: 3,
    status: "ready",
    agents: [
      {
        name: "AI主持人",
        title: "社会议题资深主持人",
        stance: "围绕社交媒体与青少年心理健康议题保持中立客观，从心理学、教育学和社会学多维度引导深入讨论。",
        color: "#6B7280",
        isHost: true,
        sortOrder: -1,
      },
      {
        name: "林雨涵",
        title: "青少年心理学研究中心主任",
        stance: "社交媒体的成瘾性设计正在系统性地损害青少年注意力机制和自尊心。平台必须引入'设计伦理'审查，而非仅仅事后补救。",
        color: "#EC4899",
        isHost: false,
        sortOrder: 0,
      },
      {
        name: "周建华",
        title: "比较教育学教授",
        stance: "北欧国家的数字素养教育值得借鉴——与其简单禁止，不如从小学阶段培养批判性媒介素养。学校和家庭需要协同而非对立。",
        color: "#06B6D4",
        isHost: false,
        sortOrder: 1,
      },
      {
        name: "刘雨桐",
        title: "数字社会行为研究所所长",
        stance: "问题根源不在技术本身，而在于社会支持的缺失。线上社交是许多边缘化青少年唯一的连接方式，'一刀切'禁令可能适得其反。",
        color: "#F97316",
        isHost: false,
        sortOrder: 2,
      },
  ...
  // -------------------------------------------------------------------------
  // 7. Commercial Space Exploration
  // -------------------------------------------------------------------------
  {
    title: "太空探索的商业化前景：星辰大海还是资本泡沫？",
    background:
      "SpaceX星舰成功实现轨道飞行，蓝色起源和维珍银河开启太空旅游时代。2025年全球航天经济规模已突破6000亿美元，私人资本大量涌入。然而，商业化也带来了轨道碎片、资源争夺和国际监管缺失等新挑战。",
    template: "roundtable",
    maxRounds: 3,
    status: "ready",
    agents: [
      {
        name: "AI主持人",
        title: "科技产业资深主持人",
        stance: "围绕太空商业化议题保持中立客观，从技术、商业和政策三个维度引导嘉宾充分讨论。",
        color: "#6B7280",
        isHost: true,
        sortOrder: -1,
      },
      {
        name: "陈志强",
        title: "航天推进系统总工程师",
        stance: "可重复使用火箭将发射成本降低了90%，这是商业化的基石。未来十年近地轨道将出现真正的'太空经济带'，包括在轨制造和太空太阳能电站。",
        color: "#3B82F6",
        isHost: false,
        sortOrder: 0,
      },
      {
        name: "赵雪梅",
        title: "航天产业投资分析师",
        stance: "太空经济的'杀手级应用'尚未出现。当前大部分商业航天公司的估值建立在远期预期上，需要警惕2000年互联网泡沫式破裂。小行星采矿至少还需20年才能商业化。",
        color: "#10B981",
        isHost: false,
        sortOrder: 1,
      },
      {
        name: "李思齐",
        title: "国际空间法研究中心副主任",
        stance: "1967年《外层空间条约》已严重滞后。月球资源开发权和轨道位置分配缺乏国际共识，可能引发新一轮'太空圈地运动'。联合国亟需建立太空商业治理框架。",
        color: "#F59E0B",
        isHost: false,
        sortOrder: 2,
      },
